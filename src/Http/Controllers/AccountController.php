...
class AccountController extends AbstractController
{
    ...
    public function deleteProfile()
    {
        ...
        try {
            ...
            return Redirect::to(Config::get('credentials.home', '/'))
                ->with('error', trans('credentials.there_was_a_problem_deleting_your_account'));
        }
        ...
        return Redirect::to(Config::get('credentials.home', '/'))
            ->with('success', trans('credentials.your_account_has_been_deleted_successfully'));
    }
    ...
    public function patchDetails()
    {
        ...
        return Redirect::route('account.profile')
            ->with('success', trans('credentials.your_details_have_been_updated_successfully'));
    }
    ...
    public function patchPassword()
    {
        ...
        $mail = [
            'url'     => URL::to(Config::get('credentials.home', '/')),
            'email'   => $user->getLogin(),
            'subject' => Config::get('app.name').' - '.trans('credentials.new_password_notification'),
        ];
        ...
        return Redirect::route('account.profile')
            ->with('success', trans('credentials.your_password_has_been_updated_successfully'));
    }
