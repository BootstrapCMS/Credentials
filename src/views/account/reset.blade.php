...
@section('title')
{{{ Lang::get('graham-campbell/credentials::account.reset.title') }}}
@stop

@section('top')
<div class="page-header">
<h1>{{{ Lang::get('graham-campbell/credentials::account.reset.title') }}}</h1>
</div>
@stop
    ...
    {{ Form::open(array('url' => URL::route('account.reset.post'), 'method' => 'POST', 'class' => 'form-horizontal')) }}
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-sm-offset-3 col-sm-10 col-xs-12">
                <button class="btn btn-primary" type="submit"><i class="fa fa-rocket"></i> {{{ Lang::get('graham-campbell/credentials::account.reset.submit') }}}</button>
            </div>
        </div>
