        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-sm-offset-3 col-sm-10 col-xs-12">
                ...
                @if (Config::get('graham-campbell/credentials::activation'))
                    <label><a href="{{ URL::route('account.reset') }}" class="btn btn-link">{{{ Lang::get('graham-campbell/credentials::user.password') }}}?</a>/<a href="{{ URL::route('account.resend') }}" class="btn btn-link">{{{ Lang::get('graham-campbell/credentials::user.activated') }}}?</a></label>
                @else
                    <label><a href="{{ URL::route('account.reset') }}" class="btn btn-link">{{{ Lang::get('graham-campbell/credentials::user.password') }}}?</a>
                @endif
            </div>
        </div>
