...
@section('title')
{{ trans('credentials.resend_activation_email') }}
@stop

@section('top')
<div class="page-header">
<h1>{{ trans('credentials.resend_activation_email') }}</h1>
</div>
@stop
...
<div class="well">
    <form class="form-horizontal" action="{{ URL::route('account.resend.post') }}" method="POST">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-sm-offset-3 col-sm-10 col-xs-12">
                <button class="btn btn-primary" type="submit"><i class="fa fa-rocket"></i> {{ trans('credentials.resend_activation_email') }}</button>
            </div>
        </div>
